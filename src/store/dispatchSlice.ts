 ...
 * - Some route fetch status fields
 * - A sheet UI state
 * - Dispatch settings (like radius)
 */
...
/**
 * The dispatch radius setting with a fallback of 50000
 */
...
/* ------------------------------------------------
   Memoized selector to decode the route polyline
   ------------------------------------------------ */
