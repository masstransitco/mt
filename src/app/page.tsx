...
const AppMenu = dynamic(() => import('@/components/ui/AppMenu'), { ssr: false });
const QrScannerOverlay = dynamic(() => import('@/components/ui/QrScannerOverlay'), { ssr: false });
        ...
        <header className="sticky top-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border h-[50px] select-none">
          <div className="relative h-full flex items-center justify-between px-0">
            ...
            <div className="flex items-center space-x-2 mr-2">
              ...
              >
                {/* 
                  Use 'currentColor' instead of a fixed color. 
                  Also set className="w-5 h-5" just like the Lucide icons. 
                */}
                <svg
                  className="w-5 h-5"
