...
export type ParkingProps = React.SVGProps<SVGSVGElement>;

export const Parking: React.FC<ParkingProps> = (props) => (
  <svg
    ...
    viewBox="0 0 24 24"
    fill="currentColor"
    className="icon icon-tabler icons-tabler-filled icon-tabler-parking-circle"
    {...props}
  >
